...
AS
	INSERT INTO [dbo].[User] (Email, PasswordSalt, PasswordHash, CreatedDateTime, LastModifiedDateTime)
	VALUES (@Email, @PasswordSalt, @PasswordHash, @CreatedDateTime, @LastModifiedDateTime)

	DECLARE @Id INT = SCOPE_IDENTITY()

	SELECT ID, Email, PasswordSalt, PasswordHash, CreatedDateTime, LastModifieddateTime FROM [dbo].[User] WHERE Id = @Id
GO
PRINT N'Creating Procedure [dbo].[UpdateUserPassword]...';
